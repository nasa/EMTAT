...
iDesign_SS_PMSM(nPoles_i,Rs_i,Ls_i,S_nom_i,T_nom_i,P_out_max_i,I_max_i,P_in_max_i,K,V_nom_i,P_Fe_nom_i,I_nom_i,PF_nom_i,P_Fe_Calc_Flag,T_max_i)
% iDesign_SS_PMSM(SNom,P_nom,Rs,Ls,K,nPoles,I,PF,CalculatePFe,V_nom)

%Is I_max_nom_i really max or not?
