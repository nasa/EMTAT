...
is a Simulink toolbox intended for use in the modeling and simulation of electrical and thermal management
systems at time scales consistant with the simualtion of mechanical systems, such as turbomachinery. EMTAT contains generic electrical and thermal management 
...
challenging modeling task. Assumptions and approximations are made in an effort to capture the steady state or time-dependent behavior relevant to engine, electrical   
