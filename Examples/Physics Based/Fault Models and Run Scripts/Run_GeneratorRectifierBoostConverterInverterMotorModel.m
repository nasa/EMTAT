%...Run GeneratorRectifierBoostConverterInverterMotorModel
...
open GeneratorRectifierBoostConverterInverterMotorModel
tstep = 0.001; %...simulation timestep
t = 1; %...simulation time
temp = 528; %...temperature, R
sim_ans = sim('GeneratorRectifierBoostConverterInverterMotorModel'); %...run slx
